...
class DatabaseHandler:
    ...
    def createUnwantedEvent(newName, oldName, fromUser):
        print("createUnwantedEvent")
        ecf = EventFactory()
        unwantedNameEvent = ecf.next_event('chat/unwantedName', {'name': newName, 'oldName': oldName, 'fromUser': fromUser})
